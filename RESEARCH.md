...
| [Latte](https://arxiv.org/abs/2401.03048) | Factorized spatial-temporal latent video processing | The video pack operates on tiny compressed clips with separate spatial/temporal paths and liquid recurrent temporal gating. | Paper-level architecture; no Latte code or weights are bundled. |
